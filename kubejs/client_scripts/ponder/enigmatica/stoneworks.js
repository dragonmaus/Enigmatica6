    ...
    event
      ...
      .scene(
        ...
        (scene, util) => {
            ...
            .showText(60)
            .colored(PonderPalette.WHITE)
            .text(`When flowing lava falls on flowing water, it creates stone. This generator floods a stair block to protect the water source.`)
            .independent(30);
            ...
            .showText(60)
            .colored(PonderPalette.WHITE)
            .text(`We can automate this with a block breaker of some sort - let's use a Modular Router with a breaker module. We'll clearly need silk touch on the breaker module.`)
            .independent(30);

            scene.idle(20);

            scene.world().destroyBlock([2, 2, 3]);
            scene.world().setBlock([2, 2, 3], Block.id('modularrouters:item_router').with('facing', 'east').blockState, false);
      ...
      .scene(
        ...
        (scene, util) => {
            ...
            .showText(60)
            .colored(PonderPalette.WHITE)
            .text(`Maybe you want something other than vanilla stone - let's say Scoria. This generator won't do.`)
            .independent(60);
            ...
            .text(`If we place a specific type of Stone under the stone generation point, the generator will now make that type of stone!`)
            .placeNearTarget()
            .pointAt([3.5,1.5,3.5]);
      ...
      .scene(
        ...
        (scene, util) => {
            ...
            .showText(60)
            .colored(PonderPalette.WHITE)
            .text(`If you place a block of Diamond under the stone generation point the generator will now make random stone!`)
            .placeNearTarget()
            .pointAt([3.5,1.5,3.5]);
