  ...
  event
    ...
    .scene(
      ...
      (scene, util) => {
        ...
        scene.world().modifyEntity(bee, e => { e.mergeFullNBT({Rotation: [NBT.floatTag(135), NBT.floatTag(0)], HasNectar: true}) });
        ...
        scene.world().setBlock([1, 0, 1], Block.id('minecraft:farmland').with('moisture', '7').blockState, false);
        scene.idle(1);
        ...
        for (let i = 3; i <= 7; i = i + 2){
          scene.world().setBlock( [1, 1, 1], Block.id('minecraft:wheat').with('age', i.toString()).blockState, false );
          scene.idle(30);
        };
      }
    )
    .scene(
      ...
      (scene, util) => {
        ...
        scene.world().modifyEntity(ironBee, e => { e.mergeFullNBT({Rotation: [NBT.floatTag(135), NBT.floatTag(0)], HasNectar: true}) });
        ...
        scene
          ...
          .showText(60)
          .colored(PonderPalette.WHITE)
          .text('Pollen can mutate things up to 2 blocks below the bee, and will pass through solid blocks to mutate things below.')
          .independent(0);
        ...
        scene.world().destroyBlock([1, 1, 1]);
        scene.idle(1);
        spawnEgg = scene.world().createItemEntity([1, 1.5, 1], [0, 0, 0], Item.of('resourcefulbees:steel_bee_spawn_egg'));

        scene.idle(40);

        scene.addKeyframe();

        scene.world().modifyEntity(ironBee, e => { e.mergeFullNBT({Pos: [1.5, 0, 1.5]}); e.kill() });
        scene.world().modifyEntity(spawnEgg, e => { e.mergeFullNBT({Pos: [2, -1, 2]}); e.kill() });
        scene.idle(20);
        var icyBee = scene.world().createEntity('resourcefulbees:icy_bee', [1.5, 4, 1.5]);
        scene.world().modifyEntity(icyBee, e => { e.mergeFullNBT({Rotation: [NBT.floatTag(135), NBT.floatTag(0)], HasNectar: true}) });
        ...
        scene.world().modifyEntity(icyBee, e => { e.mergeFullNBT({Pos: [1.5, 0, 1.5]}); e.kill() });
        scene.idle(20);
        var blazeBee = scene.world().createEntity('resourcefulbees:blaze_bee', [1.5, 4, 1.5]);
        scene.world().modifyEntity(blazeBee, e => { e.mergeFullNBT({Rotation: [NBT.floatTag(135), NBT.floatTag(0)], HasNectar: true}) });
        ...
        scene.world().modifyEntity(creeperBee, e => { e.mergeFullNBT({Rotation: [NBT.floatTag(135), NBT.floatTag(0)]}) });

        scene.idle(20);

        scene.world().modifyEntity(creeperBee, e => { e.mergeFullNBT({Pos: [1.5, 0, 1.5]}); e.kill() });
        var ghastBee = scene.world().createEntity('resourcefulbees:ghast_bee', [1.5, 1.5, 1.5]);
        scene.world().modifyEntity(ghastBee, e => { e.mergeFullNBT({Rotation: [NBT.floatTag(135), NBT.floatTag(0)]}) });

        scene.idle(40);
        scene.world().modifyEntity(ghastBee, e=> { e.mergeFullNBT({Pos: [1.5, -100, 1.5]}); e.kill() });
        ...
        scene.world().modifyEntity(blizz, e => { e.mergeFullNBT({Pos: [1.5, -1, 1.5]}); e.kill() });
        var blizzBee = scene.world().createEntity('resourcefulbees:blizz_bee', [1.5, 1.5, 1.5]);
        scene.world().modifyEntity(blizzBee, e => { e.mergeFullNBT({Rotation: [NBT.floatTag(135), NBT.floatTag(0)]}) });
    ...
    .scene(
      ...
      (scene, util) => {
        ...
        scene.world().modifyEntity(beeperBee, e => {  e.mergeFullNBT({Rotation: [NBT.floatTag(200), NBT.floatTag(0)]}) });
        ...
        .showText(60)
        .colored(PonderPalette.WHITE)
        .text(`Place the bee you'd like to mutate here; today we will be sacrificing a Beeper. Since things can be mutated through solid blocks, we can use a trap door to hold the Beeper in place.`)
        .placeNearTarget()
        .pointAt([3.5, 2, 3.5]);
        ...
        scene.world().modifyEntity(blazeBee, e => { e.mergeFullNBT({Rotation: [NBT.floatTag(90), NBT.floatTag(0)], HasNectar: false}) });
        scene.idle(20);
        ...
        for (let i = 100; i < 270; i = i + 10){
          let i2 = i;
          scene.world().modifyEntity(blazeBee, e => { e.mergeFullNBT({Rotation: [NBT.floatTag(i2), NBT.floatTag(0)], HasNectar: true}) });
          scene.idle(1);
        }
        ...
        scene
          ...
          .showText(60)
          .colored(PonderPalette.WHITE)
          .text('Now that the Blaze Bee has gathered nectar, it will travel over to its hive, dripping pollen as it goes.')
          .independent(30);
        ...
        for (let i = 2.5; i < 3.5; i = i + 0.1){
          let i2 = i;
          scene.world().modifyEntity(blazeBee, e => { e.mergeFullNBT({Pos: [i2, 3.5, 3.5]}) });
          scene.idle(1);
        }
        ...
        scene.world().modifyEntity(beeperBee, e => {  e.mergeFullNBT({Pos: [3.5, 0.5, 3.5]}) });
        var ghastBee = scene.world().createEntity('resourcefulbees:ghast_bee', [3.5, 2, 3.5]);
        scene.world().modifyEntity(ghastBee, e => {  e.mergeFullNBT({Rotation: [NBT.floatTag(200), NBT.floatTag(0)]}) });
        ...
        scene.world().modifyEntity(blazeBee, e => { e.mergeFullNBT({Pos: [3.5, 1, 3.5]}) });
